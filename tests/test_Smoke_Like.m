%% Test for the Smoke_Like matrix 
    ...
    InnerParsHer=struct('delta',delta,'maxit',maxit,'h',h,'tol',tol,...
        'theta',theta,'safestop',safestop,'r',r,'dispflag',0,'fun',...
        Hermitefun,'ranktol',ranktol,'typerank','adaptive');
    ...
    CPUtimes(j)=toc;
    k=2;
    eig_tot{k}=eig(full(A+Dist(j)*U*S*V'));
